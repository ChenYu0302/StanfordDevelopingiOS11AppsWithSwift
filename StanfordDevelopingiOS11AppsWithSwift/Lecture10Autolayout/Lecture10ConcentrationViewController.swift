...
class Lecture10ConcentrationViewController: UIViewController {

    private lazy var game = Lecture10Concentration(numberOfPairsOfCards: numberOfPairsOfCards)
    ...
    private var emoji:[Lecture10Card: String] = [:]
    
    private func emoji(for card:Lecture10Card) -> String {
