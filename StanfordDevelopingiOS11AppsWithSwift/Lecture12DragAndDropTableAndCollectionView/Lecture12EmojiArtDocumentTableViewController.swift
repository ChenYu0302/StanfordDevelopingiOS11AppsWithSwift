//
//  Lecture12EmojiArtDocumentTableViewController.swift
...
class Lecture12EmojiArtDocumentTableViewController: UITableViewController {
    ...
    override func viewWillLayoutSubviews() {
        ...
        if splitViewController?.preferredDisplayMode != .primaryOverlay {
            splitViewController?.preferredDisplayMode = .primaryOverlay // splitViewController 的 masterView 总是需要从左边划出
        }
    }
