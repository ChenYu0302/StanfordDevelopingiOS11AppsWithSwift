...
class L12EmojiArtViewController: UIViewController,UIDropInteractionDelegate, UIScrollViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDragDelegate, UICollectionViewDropDelegate
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let emojiCell = cell as? L12EmojiCollectionViewCell {
    ...
    private func dargItems(at indexPath:IndexPath) -> [UIDragItem]{
        if let attributedString = (emojiColletionView.cellForItem(at: indexPath) as? L12EmojiCollectionViewCell)?.label.attributedText  {
    ...
    var imageFetcher: L12ImageFetcher!
    
    func dropInteraction(_ interaction: UIDropInteraction, performDrop session: UIDropSession) {
        
        imageFetcher = L12ImageFetcher() { (url, image) in
            DispatchQueue.main.async {
