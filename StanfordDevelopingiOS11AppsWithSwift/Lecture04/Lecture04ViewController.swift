...
class Lecture04ViewController: UIViewController {
    ...
    private lazy var game = Lecture04Concentration(numberOfPairsOfCards: numberOfPairsOfCards)
...
//    private var emojiChoice:[String] = ["😈","🦇","🎃","👻","🙀","😱","🍎","🍬","🍭","🕷"]
    ...
    private var emoji:[Lecture04Card: String] = [:]
    
    private func emoji(for card:Lecture04Card) -> String {
