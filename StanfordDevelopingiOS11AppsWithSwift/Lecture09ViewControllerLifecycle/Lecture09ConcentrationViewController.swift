//
//  Lecture09ConcentrationViewController.swift
...
class Lecture09ConcentrationViewController: Lecture09VCLViewController {
    
    override var vclLoggingName: String {
        return "Game"
    }
    
    private lazy var game = Lecture09Concentration(numberOfPairsOfCards: numberOfPairsOfCards)
    ...
    private var emoji:[Lecture09Card: String] = [:]
    
    private func emoji(for card:Lecture09Card) -> String {
