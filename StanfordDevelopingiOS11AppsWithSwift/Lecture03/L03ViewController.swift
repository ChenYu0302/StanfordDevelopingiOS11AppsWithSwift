...
class L03ViewController: UIViewController {
    
    private lazy var game = L03Concentration(numberOfPairsOfCards: numberOfPairsOfCards)
    ...
    private func emoji(for card:L03Card) -> String {
