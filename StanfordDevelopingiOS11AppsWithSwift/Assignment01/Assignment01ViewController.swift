...
class Assignment01ViewController: UIViewController {
    
    @IBOutlet var cardButtons: [UIButton]!
    lazy var game = Assignment01Concentration(numberOfPairsOfCards: (cardButtons.count + 1) / 2)
    ...
    @IBAction func touchNewGame() {
        if game.gameOver == true {
            self.game = Assignment01Concentration(numberOfPairsOfCards: (cardButtons.count + 1) / 2)
    ...
    func emoji(for card:Assignment01Card) -> String {
