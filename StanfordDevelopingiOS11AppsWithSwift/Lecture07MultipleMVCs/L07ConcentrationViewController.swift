...
class L07ConcentrationViewController: UIViewController {
    
    private lazy var game = L07Concentration(numberOfPairsOfCards: numberOfPairsOfCards)
    ...
    private var emoji:[L07Card: String] = [:]
    
    private func emoji(for card:L07Card) -> String {
